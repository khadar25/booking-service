...
public class BookingController {
    ...
    @PostMapping
    public ResponseEntity<BookingDTO> book(@RequestBody BookingRequest bookingRequest) {
        BookingDTO booking = bookingService.bookSeats(
            bookingRequest.getUserName(),
            bookingRequest.getShowId(),
            bookingRequest.getSeats().stream().map(Long::valueOf).toList(),
